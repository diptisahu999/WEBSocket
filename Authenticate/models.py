...
# class Bms_user_vehile_details(models.Model):
#     STATUS= [
#         ("Car","Car"),
#         ("Bicycle","Bicycle"),
#         ("Cycle","Cycle"),
...
#         ("Bus","Bus"),    
#     ]
#     user_details_id=models.ManyToManyField(Bms_Roles,related_name='Role')
#     type=models.CharField(max_length=23,choices=STATUS)
#     vehile_no=models.CharField(max_length=12)
#     driver_name=models.CharField(max_length=15)
#     driver_no=models.CharField(max_length=12)
